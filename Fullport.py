...
# Advanced Custom CSS with Particle Effect and Minimalist Theme
# Replace your massive st.markdown block with this:
st.markdown("""
    <style>
    /* Root Variables */
    :root {
    ...
    /* Target the main container specifically and safely */
    [data-testid="stAppViewContainer"] {
        background: transparent;
    }

    /* TYPOGRAPHY - More specific selectors */
    .stMarkdown, .stText, [data-testid="stMetricValue"] {
    ...
    /* Fix for the "Disappearing" content: 
       We target the block container instead of generic divs */
    ...
    /* Ensure Info/Warning boxes are visible */
    .stAlert {
    ...
    <script>
    // Use a check to prevent multiple initialization on reruns
...
st.markdown("""
    <h1 style='text-align: center; margin-bottom: 0.3rem;'>FULLPORT</h1>
    <p style='text-align: center; color: #888888; font-size: 0.9rem; font-weight: 400; letter-spacing: 2px; margin-top: 0; margin-bottom: 3rem; font-family: Cousine, monospace;'>
